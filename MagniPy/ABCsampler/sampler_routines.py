...
def readout_realizations(full_lens_model, outputpath, statistic, params, fluxes):

    zlistfull, lens_listfull, arg_listfull, _, _ = full_lens_model.get_lenstronomy_args()
