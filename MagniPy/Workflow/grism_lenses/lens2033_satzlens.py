...
class WFI2033_satzlens(Quad):
    ...
    kwargs_lens_init = [{'theta_E': 0.9860615439663083, 'center_x': 0.10785484219327848, 'center_y': -0.01611526143707336,
                         'e1': -0.01713583130164682, 'e2': -0.1963393167605582, 'gamma': 1.95},
                        {'gamma1': 0.15265695864273282, 'gamma2': -0.1648210804469684}]
    ...
    satellite_redshift = [zlens, zlens]
